    ...
    <div className="max-w-md">
      <Dialog open={cropping}>
        <DialogContent onInteractOutside={() => setCropping(false)}>
          ...
          >
            <span className="font-secondary">Save</span>
          </Button>
        </DialogContent>
      </Dialog>
      ...
      <div className="items-center space-y-2">
        <Button
          className="flex font-secondary items-center gap-1 rounded-xl"
          variant="outline"
          onClick={() => {
            navigate(-1);
          }}
        ...
        <h1 className="text-2xl font-bold font-secondary">Add New Product</h1>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 mt-5">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-secondary">Product Name</FormLabel>
                <FormControl>
                  <Input
                    autoComplete="off"
                    placeholder="e.g Spicy Salmon"
                    className="border-primary/20 !mt-1 placeholder-primary/60 outline-0 font-secondary rounded-xl py-5"
                    {...field}
                  />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-secondary">Price</FormLabel>
                <FormControl>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="150.00"
                      min="0"
                      className="border-primary/20 pl-8 !mt-1 placeholder-primary/60 outline-0 font-secondary rounded-xl py-5"
                      {...field}
                    />
                  </div>
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-secondary">Category</FormLabel>
                <FormControl>
                  <Select
                    onValueChange={(e) => {
                  ...
                  >
                    <SelectTrigger className="border-primary/20 rounded-xl">
                      {field.value ? (
                        <p className="font-secondary">{field.value.label}</p>
                      ) : (
          ...
          <div className="relative">
            <div className="flex gap-2 items-center relative w-fit">
              ...
              <div className="font-secondary text-xs flex flex-col items-start justify-center">
